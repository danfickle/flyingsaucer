...
public class PageSize {
    ...
    public static final PageSize A5 = new PageSize(
            new PropertyValueImp(CSSPrimitiveUnit.CSS_MM, 148f, "148mm"),
            new PropertyValueImp(CSSPrimitiveUnit.CSS_MM, 210f, "210mm"));
    ...
    public static final PageSize A4 = new PageSize(
            new PropertyValueImp(CSSPrimitiveUnit.CSS_MM, 210f, "210mm"),
            new PropertyValueImp(CSSPrimitiveUnit.CSS_MM, 297f, "297mm"));
    ...
    public static final PageSize A3 = new PageSize(
            new PropertyValueImp(CSSPrimitiveUnit.CSS_MM, 297f, "297mm"),
            new PropertyValueImp(CSSPrimitiveUnit.CSS_MM, 420f, "420mm"));
    
    /**
     * ISO B3 media: 176mm wide by 250mm high
     */
    public static final PageSize B3 = new PageSize(
            new PropertyValueImp(CSSPrimitiveUnit.CSS_MM, 176f, "176mm"),
            new PropertyValueImp(CSSPrimitiveUnit.CSS_MM, 250, "250mm"));    
    
    /**
     * ISO B4 media: 250mm wide by 353mm high
     */
    public static final PageSize B4 = new PageSize(
            new PropertyValueImp(CSSPrimitiveUnit.CSS_MM, 250f, "250mm"),
            new PropertyValueImp(CSSPrimitiveUnit.CSS_MM, 353f, "353mm"));
    
    /**
     * North American letter media: 8.5 inches wide and 11 inches high
     */
    public static final PageSize LETTER = new PageSize(
            new PropertyValueImp(CSSPrimitiveUnit.CSS_IN, 8.5f, "8.5in"),
            new PropertyValueImp(CSSPrimitiveUnit.CSS_IN, 11f, "11in"));
    ...
    public static final PageSize LEGAL = new PageSize(
            new PropertyValueImp(CSSPrimitiveUnit.CSS_IN, 8.5f, "8.5in"),
            new PropertyValueImp(CSSPrimitiveUnit.CSS_IN, 14f, "14in"));
    ...
    public static final PageSize LEDGER = new PageSize(
            new PropertyValueImp(CSSPrimitiveUnit.CSS_IN, 11f, "11in"),
            new PropertyValueImp(CSSPrimitiveUnit.CSS_IN, 17f, "17in"));
